...
export default function DestinationPage({ destinations }: { destinations: IDestination[] }) {
  ...
  return (
    <>
      <Head><title>Space Tourism - Destination</title></Head>
      <Box tag="main" styleSheet={{
        ...
        <Box
          ...
          <Box styleSheet={{
            ...
            />
            <Text tag="h2" variant="heading2">{destination.name}</Text>
            <Text
              variant="body"
            ...
            <Box
              ...
              <Box
                ...
                <Text tag="h3" variant="subheading2" colorVariant="secondary">Avg. Distance</Text>
              ...
              <Box
                ...
                <Text tag="h3" variant="subheading2" colorVariant="secondary">Est. Travel Time</Text>
