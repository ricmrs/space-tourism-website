...
export default function TechnologyPage({ technologys }: { technologys: ITechnology[] }) {
  ...
  return (
    <>
      <Head><title>Space Tourism - Technologys</title></Head>
        ...
        <Box
          ...
          <Box
            ...
            <Box styleSheet={{
              ...
              <Text tag="h3" variant="tabText" colorVariant="secondary" styleSheet={{ opacity: '0.5' }}>The technology...</Text>
              <Text tag="h2" variant="heading3" styleSheet={{ marginBottom: '8px' }}>{technology.name}</Text>
              <Text
                variant="body"
